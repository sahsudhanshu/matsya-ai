...
export class PDFService {
  ...
  static async shareReport(uri: string): Promise<void> {
    const fileName = `OceanAI_Analytics_${new Date().toISOString().split("T")[0]}.pdf`;
        ...
        <body>
          ...
          <div class="page">
            <div style="min-height: 80vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center;">
              ...
              <h2 style="color: #1e40af; font-size: 28px; margin-bottom: 10px;">OceanAI</h2>
              ...
              <p style="color: #94a3b8; font-size: 12px; margin-top: 10px;">
                © ${new Date().getFullYear()} OceanAI - AI for Bharat
              </p>
            </div>
          </div>
        </body>
