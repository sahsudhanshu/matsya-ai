...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-5 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      ...
      size: {
        default: "h-12 min-h-[48px] px-5 py-2.5 has-[>svg]:px-4",
        sm: "h-10 min-h-[40px] rounded-md gap-1.5 px-4 text-sm has-[>svg]:px-3",
        lg: "h-14 min-h-[56px] rounded-lg px-7 text-lg has-[>svg]:px-5",
        xl: "h-16 min-h-[64px] rounded-xl px-8 py-4 text-lg has-[>svg]:px-6",
        icon: "size-12 min-h-[48px]",
        "icon-sm": "size-10 min-h-[40px]",
        "icon-lg": "size-14 min-h-[56px]",
      },
    },
    defaultVariants: {
      variant: "default",
